function Logs() {
    ...
    this.fetchLogs = async() => {
        const response = await fetch("../index.php?action=studentLogs&view", {
    ...
    this.searchLogs = () => {
        searchLogsData.oninput = async(e) => {
            ...
            if(count > 0) {
                ...
                let response = await fetch(`../index.php?action=studentLogs`, {
                  credentials: "same-origin",
                  method: 'POST',
                  body: formData
                });
    ...
    this.limitLogPages = () => {
        limitlogsnum.onchange = async(e) => {
            ...
            const response = await fetch(`../index.php?action=studentLogs&logsort=${val}`, {
                credentials: "same-origin",
                method: "GET",
            });
            let { message, status} = await response.json();
    ...
    this.totalPagesLogs= async() => {
        const response = await fetch(`../index.php?action=studentLogs&totalpage`, {
            credentials: "same-origin",
            method: "GET",
        });
    ...
    this.paginationLogs = async(pagenum) => {
        const response = await fetch(`../index.php?action=studentLogs&pagenum=${pagenum}`, {
            credentials: "same-origin",
            method: "GET",
        });
        let { message, status} = await response.json();
        ...
        btnPrintAllLogsData.onclick = async(e) => {
            ...
            .then( async(remove) => {
                if (remove) {
                    ...
                    const response = await fetch(`../index.php?action=studentLogs&print`, {
                        credentials: "same-origin",
                        method: "GET",
                    });
...
let logObj = new Logs();
logObj.fetchLogs();
logObj.limitLogPages()
logObj.totalPagesLogs();
logObj.trackDateLogs();
logObj.printAllLogsData();
logObj.searchLogs();
