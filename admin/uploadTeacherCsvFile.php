    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right mb-3">
                    ...
                    <button type="button" data-toggle="modal" data-target="#teacherUploadCsvModal" data-placement="top" title="Upload File" class="w-16 h-16 hover:border-blue-600 hover:bg-blue-100 hover:text-red-600 tracking-wide text-lg text-white bg-blue-400 py-2 rounded-full border-blue-500 border-2">
                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="9" class="text-center font-extrabold animate-bounce">Data Not Found...</td>`
                                </tr>
                            </tbody>
                        </table>
...
<!--/School Teacher Modal-->
<?php require('modals/teacher_modal.php');?>
  <!-- sweetalert -->
<script src="../assets/js/sweetAlert.js"></script>
<script src="../assets/js/papaparse.min.js"></script>
<script src="../assets/js/UploadTeacherRecordsForm.js"></script>